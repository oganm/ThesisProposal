...
Basic differential expression analyses on whole tissues are problematic because they have a known covariate that is rarely accounted for. Previous work shows that it is possible to increase the power of differential expression analysis [chikina_cellcode_2015]
